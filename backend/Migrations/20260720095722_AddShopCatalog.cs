...
{
    /// <inheritdoc />
    public partial class AddShopCatalog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_Audience_DisplayOrder",
                table: "Categories",
                columns: new[] { "Audience", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_Categories_Audience_Slug",
                table: "Categories",
                columns: new[] { "Audience", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductColors_ProductId_Name",
                table: "ProductColors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizes_ProductId_Name",
                table: "ProductSizes",
                columns: new[] { "ProductId", "Name" },
                unique: true);
        }
