    ...
    public partial class AddPromotions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionEmailDeliveries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromotionEmailDeliveries_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionEmailDeliveries_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionEmailDeliveries_PromotionId_UserId",
                table: "PromotionEmailDeliveries",
                columns: new[] { "PromotionId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PromotionEmailDeliveries_UserId",
                table: "PromotionEmailDeliveries",
                column: "UserId");
