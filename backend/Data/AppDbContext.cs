...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(user => user.FullBodyPhotoUrl);
            entity.Property(user => user.UpperBodyPhotoUrl);
            entity.Property(user => user.LowerBodyPhotoUrl);
            entity.Property(user => user.FacePhotoUrl);
            entity.Property(user => user.HeightCm).HasPrecision(5, 2);
            entity.Property(user => user.WeightKg).HasPrecision(5, 2);
            entity.Property(user => user.PreferredSize).HasMaxLength(20);
            entity.Property(user => user.BodyShape).HasMaxLength(40);
            entity.Property(user => user.ShoeSize).HasMaxLength(20);
            entity.Property(user => user.TopSize).HasMaxLength(20);
            entity.Property(user => user.BottomSize).HasMaxLength(20);
